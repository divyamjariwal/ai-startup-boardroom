def display_investor_report(analysis, startup_health_score):
    ...
    print(f"Risk Management Score: {analysis.risk_management_score}/10")
...
def display_cto_report(cto_analysis):
    ...
    print(f"Infrastructure Simplicity Score: {cto_analysis.infrastructure_simplicity_score}/10")
    print(f"Security Posture Score: {cto_analysis.security_posture_score}/10")
    print(f"Cost Efficiency Score: {cto_analysis.cost_efficiency_score}/10")
